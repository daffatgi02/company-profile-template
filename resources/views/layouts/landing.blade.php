...
<head>
    ...
    <title>{{ config('app.name', 'Santek') }}</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand fw-bold" href="#">
                    <span class="text-primary">Santek</span><span class="text-dark">.id</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#home">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#features">Features</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#about">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#services">Services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#testimonials">Testimonials</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 mx-1 rounded-pill" href="#contact">Contact</a>
                        </li>
                    </ul>
                    <a href="#contact" class="btn btn-primary rounded-pill ms-lg-4 px-4 py-2 d-none d-lg-block">Get
                        Started</a>
                </div>
            </div>
        </nav>
    ...
    <footer class="py-5">
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4">
                    <h4 class="text-white mb-4">Santek.id</h4>
                    ...
                    <div class="d-flex mt-4">
                        <a href="#" class="social-icon"><i class="fab fa-facebook-f text-white"></i></a>
                        <a href="#" class="social-icon"><i class="fab fa-twitter text-white"></i></a>
                        <a href="#" class="social-icon"><i class="fab fa-instagram text-white"></i></a>
            ...
            <div class="text-center text-white-50 mt-4">
                <p>&copy; {{ date('Y') }} Santek.id. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
